...
@Injectable()
export class JwtGatewayAccessStrategy extends PassportStrategy(
  Strategy,
  'jwt-gateway-access',
) {
  ...
  validate(
    ...
    if (
      ...
      throw new HttpException(
        {
          statusCode: ERROR_CODE.ONLY_ALLOWED_GATEWAY_ACCESS_TOKEN,
          message: 'Only gateway access tokens are allowed',
        },
